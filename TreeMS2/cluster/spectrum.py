"""
This module provides functionality for processing and transforming mass spectrometry (MS) data, specifically focused on tandem MS (MS/MS) spectra.
It includes a suite of tools to clean, filter, and normalize MS/MS spectra, converting them into lower-dimensional vectors suitable for similarity analysis and clustering.

Note:
This code was adapted from the `falcon` repository (cluster/spectrum.py):
