...
class TestSpectrumNormalizerProcessor(unittest.TestCase):
    def setUp(self):
        ...
        self.processor = SpectrumNormalizerProcessor()
    ...
    def test_process(self):
        ...
        # Validate the normalized spectrum
    ...
    def test_process_already_normalized(self):
        # Test with a spectrum that's already normalized
        ...
        # Expect no change since the spectrum was already normalized
        np.testing.assert_array_almost_equal(
            normalized_spectrum.intensity,
            normalized_intensity,
            err_msg="Normalized intensities should remain unchanged for an already normalized spectrum.",
        )

    def test_process_all_zero_intensity(self):
        # Test a spectrum with all zero intensities
