...
class TestSpectrumValidator(unittest.TestCase):
    def setUp(self):
        # Create a dummy ingestion with mz values for testing
    ...
    def test_validate_too_few_peaks(self):
        # Create a ingestion with fewer peaks
    ...
    def test_validate_too_small_mz_range(self):
        # Create a ingestion with a small mz range
        invalid_spectrum = sus.MsmsSpectrum(
            identifier="invalid_spectrum",
            precursor_mz=500.0,
            precursor_charge=2,
    ...
    def test_validate_edge_case(self):
        # Create a ingestion that exactly meets the minimum requirements
