...
from TreeMS2.ingestion.preprocessing.transformers import IntensityScaler, ScalingMethod
...
class TestIntensityScalingProcessor(unittest.TestCase):
    ...
    def test_rank_scaling(self):
        ...
        processor = IntensityScaler(scaling=ScalingMethod.RANK, max_rank=max_rank)
    ...
    def test_invalid_max_rank(self):
        ...
        max_rank = 3  # Less than the number of peaks in the ingestion
        processor = IntensityScaler(scaling=ScalingMethod.RANK, max_rank=max_rank)
